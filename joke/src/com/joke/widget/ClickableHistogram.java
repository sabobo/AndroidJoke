...
public class ClickableHistogram extends LinearLayout {
     ...
     */
    private List<ColumnData> dataSource = new ArrayList<ColumnData>();
    /**
     * 实际的图列控件
     */
    ...
    public ClickableHistogram(Context context, AttributeSet attrs) {
        ...
        columnColor = typedArray.getColor(R.styleable.ClickableHistogram_columnColor,Color.parseColor("#039DE5"));
        axisColor = typedArray.getColor(R.styleable.ClickableHistogram_axisColor,Color.parseColor("#EFEFEF"));
        textColor = typedArray.getColor(R.styleable.ClickableHistogram_textColor,Color.parseColor("#FFFFFF"));
        typedArray.recycle();
    }
