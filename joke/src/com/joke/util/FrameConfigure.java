...
public class FrameConfigure {
    ...
    public static final String MAIN_FOLDER = "/mnt/sdcard/jokeapp/";
    //public static final String MAIN_FOLDER = "/mnt//sdcard/weifenxiaoapp/";
    ...
    /** 微信分享图片路径 */
    public static final String WEIXIN_IMG_DRC = NORMAL_DRC + "WeiXinImage/";
    /** APK路径 */
